...
export default function Home() {
  ...
  if (loading) {
    return <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", Helvetica, sans-serif', background: bgColor, color: textColor }}>Lade Speisekarte...</div>;
  }
      ...
      <header style={{ position: 'sticky', top: 0, background: headerBg, backdropFilter: 'blur(20px)', borderBottom: `0.5px solid ${borderColor}`, zIndex: 100, padding: '12px 0' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            <button onClick={() => setDarkMode(!darkMode)} style={{ background: darkMode ? '#3a3a3c' : '#e8e8ed', border: 'none', cursor: 'pointer', padding: '8px', borderRadius: '30px', display: 'flex', alignItems: 'center', justifyContent: 'center', width: '36px', height: '36px' }} title={darkMode ? 'Hellmodus' : 'Dunkelmodus'}>
              {darkMode ? (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={textColor} strokeWidth="2"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
              ) : (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={textColor} strokeWidth="2"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
              )}
            </button>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '24px' }}>
        ...
        {activeTab === 'cart' && !showCheckout && (
          <div>
            ...
            <div style={{ background: darkMode ? '#2a3a2a' : '#e8f5e9', borderRadius: 12, padding: 12, marginBottom: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#2e7d32" strokeWidth="2"><path d="M1 3h15v13H1z"/><path d="M16 8h4l3 3v5h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>
      ...
      <footer style={{ background: darkMode ? '#1c1c1e' : '#f5f5f7', padding: '48px 24px 32px', marginTop: 60, borderTop: `0.5px solid ${borderColor}`, textAlign: 'center' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'center', gap: 48, flexWrap: 'wrap', marginBottom: 32 }}>
            <div><div style={{ fontSize: '0.7rem', color: textSecondary, textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: 8 }}>Adresse</div><div style={{ fontSize: '0.875rem', color: textColor }}>Gevelsberger Str. 28, 45549 Sprockhövel</div></div>
            <div><div style={{ fontSize: '0.7rem', color: textSecondary, textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: 8 }}>Telefon</div><div style={{ fontSize: '0.875rem', color: textColor }}>02339 9116777</div></div>
