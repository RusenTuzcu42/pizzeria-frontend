export default function Impressum() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 20px', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", Helvetica, sans-serif' }}>
      <h1 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: '24px' }}>Impressum</h1>
      
      <p><strong>Pizzeria Napoli</strong><br />
      ...
      Die Umsatzsteuer-Identifikationsnummer wird nachgereicht.</p>
      ...
      Wir sind nicht verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.</p>
      ...
      <p style={{ marginTop: '32px', fontSize: '0.875rem', color: '#666' }}>Quelle: e-recht24.de</p>
    </div>
  );
}
